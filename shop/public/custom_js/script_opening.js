...
$(".addmore").on('click',function(){
	...
	html +=' <td> <input type="number" min="0" step="any" name="cost_per_unit[]" class="form-control changesNo" id="cost_'+i+'" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
	html+='<td> <input type="number" min="0" step="any" name="sales_per_unit[]" class="form-control"> </td>';
