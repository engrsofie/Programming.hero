                ...
                <div class="invoice-header" style="width: 100%; height: 130px;">
                    <div class="client_info" style="width: 64%; float: left;">
                        <div class="list">
                            ...
                            <label> {{$data['getClientData']->client_name}}</label>
                        </div>
                        <div class="list">
                            <label> Client Address :</label>
                            <label> {{$data['getClientData']->address}}</label>
                        </div>
                        <div class="list">
                            <label> Client Phone :</label>
                            <label> {{$data['getClientData']->mobile_no}}</label>
                        </div>
                        <div class="list">
                            <label> Client Email :</label>
                            <label> {{$data['getClientData']->email_id}}</label>
                        </div>
                    </div>
                    <div class="client_invoice_id" style="width: 36%; float: right;">
                       <!-- <div class="list">
                            Invoice Id :
                            <label># {{$data['getClientData']->invoice_no}}</label>
                        </div>
                        <div class="list">
                            Data :
                            <label> {{$data['getClientData']->t_date}}</label>
                        </div> --> 
                    </div>
                </div>
                ...
                <div class="invoice-content">
                    <div class="table-responsive">
                        <table class="table table-invoice table-bordered">
                            ...
                            <tbody>
                            @foreach($data['getInvoiceData'] as $invoiceItemData)
                                <tr>
                                    <td>
