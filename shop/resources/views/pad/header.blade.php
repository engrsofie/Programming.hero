...
<div class="view_logo" style="margin: 0 auto;width: 100%;text-align: center;">
    <img class="print-logo" src='{{asset("images/company/logo/$companyInfo->company_logo")}}' style="width: auto;height: 60px;position: relative;top: -24px;left: 0;">
    <div class="pad_top_content" style="display: inline-block;">
        ...
        Phone: {{$companyInfo->company_phone}}, Email: {{$companyInfo->company_email}}</p>
    </div>
</div>
</div>