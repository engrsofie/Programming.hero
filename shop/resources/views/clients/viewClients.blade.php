                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                                <a class="btn btn-warning btn-xs" href="{{URL::to('/client/create')}}">Add New Client</a>
                            </div>
                                        ...
                                        <!-- edit section -->
                                            ...
                                            <div class="modal fade" id="modal-dialog<?php echo $client->id;?>">
                                                <div class="modal-dialog">
                                                    ...
                                                    {!! Form::open(array('route' => ['client.update',$client->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-3 col-sm-3">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="client_status" value="1" id="radio-required" data-parsley-required="true" @if($client->client_status=="1"){{"checked"}}@endif> Active
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4 col-sm-4">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="client_status" id="radio-required2" value="0" @if($client->client_status=="0"){{"checked"}}@endif> Inactive
                                                                        </label>
                                                                    </div>
                                                                </div> 
                                                            </div>   
