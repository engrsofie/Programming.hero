	@extends('layout.app')
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<li><a class="btn btn-info" href="{{URL::to('/category/create')}}">Add New Category</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
                                        ...
                                        <!-- edit section -->
                                            ...
                                            <div class="modal fade" id="modal-dialog<?php echo $category->id;?>">
                                                <div class="modal-dialog">
                                                    ...
                                                    {!! Form::open(array('route' => ['category.update',$category->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 col-sm-8">
                                                                    <input class="form-control" type="hidden" id="company_name" name="company_name" value="<?php echo $category->company_name; ?>" data-parsley-required="true" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-3 col-sm-3">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="category_status" value="1" id="radio-required" data-parsley-required="true" @if($category->category_status=="1"){{"checked"}}@endif> Active
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4 col-sm-4">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="category_status" id="radio-required2" value="0" @if($category->category_status=="0"){{"checked"}}@endif> Inactive
                                                                        </label>
                                                                    </div>
                                                                </div> 
                                                            </div>
                                                           <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 col-sm-8">
                                                                    {{ Form::select('category_type', ['Payment'=>'Payment','Deposit'=>'Deposit'], $category->category_type, ['class'=> 'form-control','data-title'=> 'Single Select','data-style'=> 'btn-default btn-block','data-menu-style'=>'dropdown-blue'])}}
                                                                </div>
                                                            </div>
