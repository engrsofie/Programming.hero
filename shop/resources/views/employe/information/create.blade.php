			    ...
			    <div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            {!! Form::open(array('route' => 'employe-information.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                                ...
                                <div class="form-group {{ $errors->has('fk_section_id') ? 'has-error' : '' }}">
									...
									<div class="col-md-6 col-sm-6">
										{{Form::select('fk_section_id',$section,'',['class'=>'form-control','placeholder'=>'Select Section','required'])}}
