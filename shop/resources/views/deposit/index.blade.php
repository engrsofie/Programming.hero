                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <div class="panel-heading-btn">
                            <a class="btn btn-xs btn-primary" href="{{URL::to('/deposit')}}">View All Deposit List</a>
                            
                        </div>
                        <h4 class="panel-title">Deposit Page</h4>
                    </div>
                    <div class="panel-body">
                        {!! Form::open(array('route' => 'deposit.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
