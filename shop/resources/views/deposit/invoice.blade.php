		...
		<div id="content" class="content">
            ...
            <div class="invoice">
                <div class="invoice-company">
                    ...
                    <a class="printbtn btn btn-sm btn-info m-b-10" href='{{URL::to("deposit/$getInvoiceData->id/edit")}}'><i class="fa fa-pencil"></i> Edit</a>
                    </span>
                        ...
                        <div class="invoiceInfo" style="width: 40%;float: left;">
                            <table class="table table-bordered">
                                ...
                                @if($singleHistory->invoice_id!=$getInvoiceData->invoice_no)
                                    <small>(Ref. Invoice: <a target="_blank" class="reflink" href='{{URL::to("deposit/$getInvoiceData->invoice_no")}}'>{{$getInvoiceData->invoice_no}}</a><span class="refId">{{$getInvoiceData->invoice_no}}</span>)</small>
                                @endif
                                </th>
                                </tr>
                                 <tr>
