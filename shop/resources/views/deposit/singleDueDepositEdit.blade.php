                                        ...
                                        <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                            ...
                                            <div class="form-group transition_cul_section">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input value="<?php echo $getDepositData->amount-$getDepositData->total_paid;?>" type="number" min="0" step="any" class="form-control" id="total_amount" placeholder="Paid Amount" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group transition_cul_section">
