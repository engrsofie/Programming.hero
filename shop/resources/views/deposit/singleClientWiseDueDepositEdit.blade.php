		    ...
		    <div class="col-md-12">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        {!! Form::open(array('route' => ['client-wise-due-deposit.update',$getClientData->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                                        ...
                                        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                            <table class="table table-bordered table-hover" id="table_auto">
                                                ...
                                                @if(isset($getInvoiceData))
                                                    <?php $i=0; ?>
                                                    @foreach($getInvoiceData as $depositItem)
                                                        <?php $i++; ?>
                                                    <tr>
                                                        <td><input class="case" type="checkbox"/></td>
                                                        
                                                        <td>
                                                            <input class="form-control" value="{{$depositItem->sub_category_name}}" required="required" readonly="readonly">
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="text" data-type="description" id="description_1" value="{{$depositItem->description}}" class="form-control autocomplete_txt" autocomplete="off" required readonly="readonly">
                                                            
                                                        </td>
                                                        <td>
                                                            <input type="number" min="0" id="price_1" class="form-control onChangeAmount" value="{{$depositItem->total_amount}}" readonly="readonly">
                                                            
                                                        </td>
                                                        <td>
                                                            <input type="number" min="0" id="paid_1" class="form-control onChangeAmountPaid" value="{{$depositItem->paid_amount}}" required readonly="readonly">
                                                            
                                                        </td>
                                                        <td>
                                                            <input type="number" min="0" max="<?php echo intval($depositItem->total_amount)-intval($depositItem->paid_amount);?>" name="paid[]" id="paid_<?php echo $depositItem->id; ?>" class="form-control paid" value="0" required>
