                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading"> 
                        <div class="panel-heading-btn">
                                <a class="btn btn-info btn-xs" href="{{URL::to('/inventory-product-add')}}">All Added Product</a>
                                
                            </div>
                        <h4 class="panel-title">Add Product</h4>
                    </div>
                    <div class="panel-body no-padding">
                        {!! Form::open(array('route' => 'inventory-product-add.store','class'=>'form-horizontal purchase-form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                            <div class="col-md-12">
                                ...
                                <div class='row'>
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" tabindex="-1" class="form-control" name="challan_id" value="{{$invoice}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4 pull-right">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="date" value="{{date('d-m-Y')}}" class="form-control datepicker">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if(Auth::user()->isRole('administrator'))
                                                            {{Form::select('fk_branch_id[]',$branch,Auth::user()->fk_branch_id,['class'=>'form-control branchSelect','required'])}}
                                                        @else
                                                            <span>{{$ownBranch->branch_name}}</span>
                                                            <input type="hidden" name="fk_branch_id[]" value="{{$ownBranch->id}}">
                                                        @endif
                                                        </div>
                                                    </td>
                                                </tr>
