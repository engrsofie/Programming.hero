		    ...
		    <div class="col-md-12">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body" id="tabArea">
                        {!! Form::open(array('route' => 'inventory-product-sales.store','class'=>'form-horizontal sales-form','method'=>'POST','role'=>'form','data-parsley-validate novalidate')) !!}
...
<script type="text/javascript">
    function client_info($id){
        ...
        $('#clientPrev').load("{{URL::to('loadClientPrev')}}/"+$id+"/"+total);
    }
