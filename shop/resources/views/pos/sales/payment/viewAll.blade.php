                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                                <a class="btn btn-info btn-xs" href="{{URL::to('/inventory-sales-payment/create')}}">Add New Payment</a>
    ...
    <script type="text/javascript">
        $(function() {
            $('#all_data').DataTable( {
                processing: true,
                serverSide: true,
                ajax: '{!! URL::asset("inventory-sales-all-payment") !!}',
                columns: [
                    { data: 'invoice_id',name:'inventory_payment_history.invoice_id'},
