            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> 
                    <div class="panel-heading-btn">
                        <a class="btn btn-info btn-xs" href="{{URL::to('/pos-sales/create')}}">Refresh</a>
                        <a class="btn btn-info btn-xs" href="{{URL::to('/inventory-product-sales')}}">View All</a>
                    </div>
                ...
                <div class="panel-body min-padding">
                    <div class="col-md-8 no-padding-left">
                        <div class="col-md-12 no-padding">
                           <table class="table table-bordered table-hover" id="table_auto">
                            ...
                            <hr>
                             {!! Form::open(array('route' => 'pos-sales.store','class'=>'form-horizontal sales-form','method'=>'POST','role'=>'form','data-parsley-validate novalidate')) !!}
                    ...
                    <div class="col-md-4 posPaymentSummary">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-7">
                                {{Form::select('fk_account_id',$accounts,1,['class'=>'form-control'])}}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-7">
                                {{Form::text('ref_id','',['class'=>'form-control','placeholder'=>'Trx No'])}}
                            </div>
                        </div>
                                {{Form::hidden('date',date('d-m-Y'))}}
                        <div class="form-group">
                            <label class="col-md-5 control-label">Client Name :</label>
                            <div class="input-group col-md-7">
                                {{Form::text('client_name','',['class'=>'form-control','placeholder'=>'Client Name','id'=>'client_name','onkeypress'=>"autoCompleteClient('client_name')"])}}
                            </div>
                        </div>
                        <div class="form-group">
...
@endsection
@section('script')
<script src="{{asset('public/custom_js/script_posSales.js')}}"></script> 
@if(isset($salesId) && $salesId!='')
<script src="{{asset('public/custom_js/printThis.js')}}"></script>
<script type="text/javascript">
    
$('#loadPrint').load('{{URL::to("pos-sales?id=$salesId")}}');
$('#loadPrint').printThis();
</script>
@endif
<script type="text/javascript">
