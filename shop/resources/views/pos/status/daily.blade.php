                            ...
                            ?>
                                ...
                                <div class="form-group col-md-3 no-padding">
                                    ...
                                    <div class="col-md-12" id="loadCLient">
                                        {{Form::select('fk_client_id',$clients,$clientId,['class'=>'form-control select','placeholder'=>'All Clients','id'=>'client'])}}
                                    </div>
                                </div>
...
<script type="text/javascript">
    $("#submit").click(function(){
        ...
        window.location='{{URL::to("/inventory-sales-daily")}}?end='+end+'&start='+start+'&branch='+branch+'&client='+client;
