                        ...
                        <div class="panel-body">
                            ...
                            <div class="modal fade" id="modal-dialog">
                                <div class="modal-dialog">
                                    ...
                                    {!! Form::open(array('route' => 'inventory-brand.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
	                                    ...
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <!-- edit section -->
	                                            ...
	                                            <div class="modal fade" id="modal-dialog<?php echo $brand->id;?>">
	                                                <div class="modal-dialog">
	                                                    <div class="modal-content">
	                                                    {!! Form::open(array('route' => ['inventory-brand.update',$brand->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
	                                                        <div class="modal-header">
	                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	                                                        ...
	                                                        <div class="modal-body">
	                                                            ...
	                                                            <div class="form-group">
	                                                                ...
	                                                                <div class="col-md-3 col-sm-3">
	                                                                    <div class="radio">
	                                                                        <label>
	                                                                            <input type="radio" name="status" value="1" id="radio-required" data-parsley-required="true" @if($brand->status=="1"){{"checked"}}@endif> Active
	                                                                        </label>
	                                                                    </div>
	                                                                </div>
	                                                                <div class="col-md-4 col-sm-4">
	                                                                    <div class="radio">
	                                                                        <label>
	                                                                            <input type="radio" name="status" id="radio-required2" value="0" @if($brand->status=="0"){{"checked"}}@endif> Inactive
	                                                                        </label>
	                                                                    </div>
	                                                                </div> 
	                                                            </div>
	                                            ...
	                                            <!-- delete section -->
	                                            {!! Form::open(array('route'=> ['inventory-brand.destroy',$brand->id],'method'=>'DELETE')) !!}
