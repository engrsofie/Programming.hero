                    ...
                    <div class="panel panel-inverse">
                        ...
                        <?php if(Auth::user()->isRole('administrator')): ?>
                           <div class="form-group col-md-5">
                               ...
                               <div class="col-md-8">
                                   <?php echo e(Form::select('fk_branch_id',$branch,$branchId,['class'=>'form-control onchange','placeholder'=>'Select Branch','id'=>'branch'])); ?>
                        ...
                        <?php endif; ?>
                           <div class="form-group col-md-6">
                               ...
                               <div class="col-md-8">
                                   <?php echo e(Form::select('fk_branch_id',$category,$categoryId,['class'=>'form-control onchange','placeholder'=>'All Category','id'=>'category'])); ?>
                            ...
                            <div class="col-md-6" style="width: 70%">
                              <table class="table table-bordered" width="100%">
                                <tr class="active">
                                  ...
                                  <th width="20%" id="totalQty"><?php echo e($data->qty); ?></th>

                                  <th width="30%" style="text-align: right;">Total Value: </th>
                                  <th width="20%" id="totalPrice"><?php echo e($data->price); ?></th>
                                </tr>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
        $('.onchange').on('change',function(){
            ...
            window.location='<?php echo e(URL::to("/inventory")); ?>?branch='+branch+'&category='+category;
        ...
        $(function() {
            ...
            $('#all_data').DataTable( {
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(URL::to("inventory/create")); ?>?branch='+branch+'&category='+category,
                columns: [
