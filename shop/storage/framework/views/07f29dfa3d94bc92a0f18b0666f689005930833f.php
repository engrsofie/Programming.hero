  ...
  $(this).off('mousewheel.disableScroll')
    ...
    //  */
     ...
     $(".addmore").on('click',function(){
        ...
        html += '<td><select name="fk_sub_category_id[]" data-placeholder="- Select -" class="select form-control select" tabindex="10" required="required"><option value="">Please choose</option><?php foreach ($subCategories as $subCategory){ ?><?php if($subCategory->sub_category_type=="Deposit"): ?><option value="<?php echo $subCategory->id; ?>"><?php echo $subCategory->sub_category_name; ?></option><?php endif; ?><?php } ?></select></td>';
