                            ...
                            ?>
                                <div class="form-group col-md-3 no-padding">
                                    ...
                                    <div class="col-md-9 no-padding">
                                        <input class="form-control" type="date"  name="start" value="<?php echo e($start); ?>" data-parsley-required="true" id="start" />
                                    </div>
                                ...
                                <div class="form-group col-md-2 no-padding">
                                 <label class="control-label col-md-12" for="Date">End Date* :</label>
                                    <div class="col-md-12 no-padding">
                                        <input class="form-control" type="date"  name="end" value="<?php echo e($end); ?>" data-parsley-required="true"  id="end" />
                                    </div>
                                </div>
                                <? 
                                $branchId='';
                                ...
                                <div class="form-group col-md-3 no-padding">
                                    ...
                                    <div class="col-md-12" id="loadCLient">
                                        <?php echo e(Form::select('fk_client_id',$clients,$clientId,['class'=>'form-control select','placeholder'=>'All Organization','id'=>'client'])); ?>
...
<script type="text/javascript">
    $("#submit").click(function(){
        ...
        window.location='<?php echo e(URL::to("/inventory-daily-sales")); ?>?end='+end+'&start='+start+'&branch='+branch+'&client='+client;
    ...
    function loadCLient(id){
        ...
        $('#loadCLient').load('<?php echo e(URL::to("inventory-client-load")); ?>/'+id);
    }
