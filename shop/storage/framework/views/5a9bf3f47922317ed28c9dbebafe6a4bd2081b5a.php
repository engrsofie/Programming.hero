		    ...
		    <div class="col-md-12">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <?php echo Form::open(array('route' => ['company-info.update',$getCompanyData->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
                            ...
                            <div class="company_info_section">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group col-md-12 <?php echo e($errors->has('company_logo') ? 'has-error' : ''); ?> ">
                                            <label class="control-label col-sm-7">Company Logo * </label>
                                            <div class="col-md-5">
                                              <label class="slide_upload" for="file">
                                                  <!--  -->
                                                  <img id="image_load" src='<?php echo e(asset("images/company/logo/$getCompanyData->company_logo")); ?>'>
                                              </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group col-md-12 <?php echo e($errors->has('company_icon') ? 'has-error' : ''); ?> ">
                                            <label class="control-label col-sm-7">Company Ico * </label>
                                            <div class="col-md-5">
                                              <label class="slide_upload" for="file-ico">
                                                  <!--  -->
                                                  <img id="image_load_ico" src='<?php echo e(asset("images/company/ico/$getCompanyData->company_icon")); ?>'>
                                              </label>
                                              <input type="file" id="file-ico" name="company_icon" onchange="readURL(this,this.id)" style="display:none">
                                               <?php if($errors->has('company_icon')): ?>
                                                  <span class="help-block" style="display:block">
                                                      <strong><?php echo e($errors->first('company_icon')); ?></strong>
                                                  </span>
                                                <?php endif; ?>
                                            </div>
                                          </div>   
