		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<li><a class="btn btn-info" href="<?php echo e(URL::to('/payment-method/create')); ?>">Add New Payment Method</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
                                        ...
                                        <!-- edit section -->
                                            ...
                                            <div class="modal fade" id="modal-dialog<?php echo $method->id;?>">
                                                <div class="modal-dialog">
                                                    ...
                                                    <?php echo Form::open(array('route' => ['payment-method.update',$method->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-3 col-sm-3">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="method_status" value="1" id="radio-required" data-parsley-required="true" <?php if($method->method_status=="1"): ?><?php echo e("checked"); ?><?php endif; ?>> Active
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4 col-sm-4">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="method_status" id="radio-required2" value="0" <?php if($method->method_status=="0"): ?><?php echo e("checked"); ?><?php endif; ?>> Inactive
                                                                        </label>
                                                                    </div>
                                                                </div> 
                                                            </div>
                                            ...
                                            <!-- delete section -->
                                            <?php echo Form::open(array('route'=> ['payment-method.destroy',$method->id],'method'=>'DELETE')); ?>

                                                <?php echo e(Form::hidden('id',$method->id)); ?>
