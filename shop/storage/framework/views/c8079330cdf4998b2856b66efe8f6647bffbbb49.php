                        ...
                        <div class="panel-body">
                            ...
                            <div class="modal fade" id="modal-dialog">
                                <div class="modal-dialog">
                                    ...
                                    <?php echo Form::open(array('route' => 'inventory-small-unit.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
                        ...
                        <div class="view_uom_set">
                        	<div class="panel-body">
	                            <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
	                                ...
	                                <tbody>
	                                <?php $i=0; ?>
	                                <?php $__currentLoopData = $getuomData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                <?php $i++; ?>
	                                    <tr class="odd gradeX">
	                                        <td><?php echo e($i); ?></td>
	                                        <td><?php echo e($uom->small_unit_name); ?></td>
	                                        <td>
	                                        	<?php if($uom->status=="1"): ?>
	                                        		<?php echo e("Active"); ?>
	                                        ...
	                                        <!-- edit section -->
	                                            ...
	                                            <div class="modal fade" id="modal-dialog<?php echo $uom->id;?>">
	                                                <div class="modal-dialog">
	                                                    <div class="modal-content">
	                                                    <?php echo Form::open(array('route' => ['inventory-small-unit.update',$uom->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
	                                                        ...
	                                                        <div class="modal-body">
	                                                            ...
	                                                            <div class="form-group">
	                                                                ...
	                                                                <div class="col-md-3 col-sm-3">
	                                                                    <div class="radio">
	                                                                        <label>
	                                                                            <input type="radio" name="status" value="1" id="radio-required" data-parsley-required="true" <?php if($uom->status=="1"): ?><?php echo e("checked"); ?><?php endif; ?>> Active
	                                                                        </label>
	                                                                    </div>
	                                                                </div>
	                                                                <div class="col-md-4 col-sm-4">
	                                                                    <div class="radio">
	                                                                        <label>
	                                                                            <input type="radio" name="status" id="radio-required2" value="0" <?php if($uom->status=="0"): ?><?php echo e("checked"); ?><?php endif; ?>> Inactive
	                                                                        </label>
	                                                                    </div>
	                                                                </div> 
	                                                            </div>
	                                            ...
	                                            <!-- delete section -->
	                                            <?php echo Form::open(array('route'=> ['inventory-small-unit.destroy',$uom->id],'method'=>'DELETE')); ?>

	                                                <?php echo e(Form::hidden('id',$uom->id)); ?>
