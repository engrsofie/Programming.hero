                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading"> 
                        <div class="panel-heading-btn">
                                <a class="btn btn-info btn-xs" href="<?php echo e(URL::to('/inventory-product-damage')); ?>">All Damage Products</a>
                                
                            </div>
                        <h4 class="panel-title">Damage Product</h4>
                    </div>
                    <div class="panel-body no-padding">
                        <?php echo Form::open(array('route' => 'inventory-product-damage.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
...
<script src="<?php echo e(asset('public/custom_js/script_damage.js')); ?>"></script>
<?php $__env->stopSection(); ?>
