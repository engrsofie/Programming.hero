		    ...
		    <div class="col-md-12">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <!-- <form method="post"> -->
                        	<form action="<?php echo e(URL::to('report-deposit')); ?>" method="GET">
                            <div class="report_filler">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <?php echo e(Form::date('start',date('Y-m-d'),['class'=>'form-control','placeholder'=>'Start Date'])); ?>
                                ...
                                <div class="form-group col-md-3">
                                 <label class="control-label col-md-12" for="Date">End Date* :</label>
                                    <div class="col-md-12">
                                        <?php echo e(Form::date('end',date('Y-m-d'),['class'=>'form-control','placeholder'=>'End Date'])); ?>
                            ...
                            <div id="show-report">
                                ...
                                <div class="invoice-content">
                                    ...
                                    <div class="filter_info">
                                        <h3 align="center">Income &amp; Expense Reports <br> <small><?php echo e($branchName); ?></small> </h3>
                                        <table class="table table-bordered">
                                            <tr>
                                                 <td><b>From : </b> <?php echo e($filterData['start']); ?></td>
                                                <td><b>To : </b> <?php echo e($filterData['start']); ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="div">
                                        ...
                                        <table class="table table-bordered padding5">
                                            ...
                                            <tfoot>
                                                <tr class="active">
                                                    ...
                                                    <th><?php echo e(round($totalAmount+$sales->total_amount,3)); ?></th>
                                                </tr>
                                        ...
                                        <table class="table table-bordered padding5">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(round($purchase->total_amount,3)); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>Total Salary</td>
                                            ...
                                            <tfoot>
                                                <tr class="active">
                                                    <th>*</th>
                                                    <th class="text-right">Total = </th>
                                                    <th><?php echo e(round($totalAmount+$purchase->total_amount+$salary->total_amount,3)); ?></th>
                                                </tr>
                                ...
                                <?php if(Auth::user()->isRole('administrator')): ?>
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered padding5">
                                            ...
                                            $totalPaid=0;
                                             ?>
                                            <?php $__currentLoopData = $accountReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acReport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?
                                            $totalAmount+=$acReport['balance'];
                                            ?>
                                                <tr>
                                                    <td><?php echo e($i++); ?></td>
                                                    <td><?php echo e($acReport['account_name']); ?></td>
                                                    <td><?php echo e($acReport['balance']); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                            <tfoot>
...
<script type="text/javascript">
    ...
    $("#submit").click(function(){
            ...
            $.ajax({
                url: "<?php echo e(URL::to('/')); ?>"+'/deposit-report-generat',
                type: "GET",
                data: {
                        form_date:  form_date,
                        to_date:  to_date
