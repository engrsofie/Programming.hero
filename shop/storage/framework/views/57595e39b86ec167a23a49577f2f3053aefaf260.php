                        ...
                        <div class="panel-body">
                            ...
                            <div class="modal fade" id="modal-dialog">
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <?php echo Form::open(array('route' => 'inventory-supplier.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
    ...
    <script type="text/javascript">
        $(function() {
            $('#all_data').DataTable( {
                processing: true,
                serverSide: true,
                ajax: '<?php echo URL::asset("inventory-supplier/create"); ?>',
                columns: [
                    { data: 'representative'},
                    { data: 'company_name'},
