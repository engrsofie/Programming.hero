			    ...
			    <div class="col-md-12">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <?php endif; ?>
                            	<a class="btn btn-info btn-xs" href="<?php echo e(URL::to('/inventory-order-payment')); ?>">View All</a>
                                ...
                                <div class="col-md-7 col-md-offset-3">
                            	    <div class="form-group">
                                        ...
                                        <? $id= isset($client)?$client->id:''?>
                                            <?php echo e(Form::select('id',$clients,$id,['class'=>'form-control select','placeholder'=>'Select Organization','required' ,'onchange'=>'loadDue(this.value)'])); ?>
                        ...
                        <?php echo Form::open(array('route' => 'inventory-order-payment.store','class'=>'form-horizontal','method'=>'POST','role'=>'form','data-parsley-validate novalidate')); ?>
                        ...
                        <div id="print_body" style="width: 100%;overflow: hidden; padding: 10px 20px;">
                          <?php echo $__env->make('pad.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td><?php echo e($i); ?></td>
                                    <td><a href='<?php echo e(URL::to("inventory-product-add/$data->invoice_id")); ?>'><?php echo e($data->invoice_id); ?></a> </td>
                                    <td><?php echo e($data->date); ?></td>
                                    <td><?php echo e(round($data->total_amount,3)); ?>

                                    </td>
                                    <td><?php echo e(round($data->total_paid,3)); ?></td>
                                    <td><?php echo e(round($data->total_amount-$data->total_paid,3)); ?></td>
                                </tr>
                                <input type="hidden" name="fk_order_id[]" value="<?php echo e($data->id); ?>">
                                <input type="hidden" name="order_last_due[]" value="<?php echo e($data->total_amount-$data->total_paid); ?>">
                        ...
                        <input type="hidden" name="fk_supplier_id" value="<?php echo e($client->id); ?>">
                        <div class="col-md-6">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    function loadDue(id){
        window.location='<?php echo e(URL::to("/inventory-order-payment")); ?>/'+id;
    }
</script>
<?php $__env->stopSection(); ?>
